...
function GeoFaqs({
  ...
  const faqs = [
    {
      q: `Is Casinova Gaming available in ${location}?`,
      a: `Yes — Casinova Gaming serves players across ${stateName}${cityName ? `, including ${cityName}` : ""}. Our sweepstakes fish table and slot games are playable online from ${location}.`,
    },
    {
      q: `How do I get started from ${location}?`,
      a: `Create a free Casinova Gaming account, deposit via CashApp, Zelle, Bitcoin or USDT, then create a game account and load credits from your wallet.`,
    },
    {
    ...
    <>
      ...
      <main className="pt-24 pb-16">
        ...
        <MarketingGameGrid
          ...
          lede={`All Casinova Gaming games are playable online from ${locationName}. Create your account, deposit, and load credits in minutes.`}
        />
