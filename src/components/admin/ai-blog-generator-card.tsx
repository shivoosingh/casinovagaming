...
const BLOG_PRESETS = [
  {
    ...
    keywords: "juwa 777, juwa free credits, juwa login, Casinova juwa",
  },
  {
    name: "Orion Stars Tips",
    topic: "Orion Stars Online Play & Secret Winning Strategies",
    keywords: "orion stars, orion stars bonus, fish table tips, Casinova gaming",
  },
  {
    name: "Fire Kirin Cashout",
    topic: "Fire Kirin Fast Deposit & Payout Walkthrough",
    keywords: "fire kirin, fire kirin deposit, fire kirin app, Casinova bonus",
  },
  {
    name: "Game Vault VIP",
    topic: "Game Vault VIP Unlock Code & Bonus Rules",
    keywords: "game vault, game vault 999, game vault login, Casinova VIP",
  },
  {
    name: "Fish Table Bosses",
    topic: "Top 5 Fish Table Games with Highest Payout Multipliers",
    keywords: "fish table games, ocean king, fish game strategy, Casinova slots",
  },
  {
    name: "Casinova Cashout",
    topic: "Casinova Instant Cashout & Daily Wheel Rewards Guide",
    keywords: "Casinova gaming, Casinova cashout, Casinova bonus wheel, fast payouts",
  },
];
        ...
        <div className="grid gap-4 md:grid-cols-2">
          ...
          <div>
            ...
            <input
              ...
              placeholder="e.g. orion stars, Casinova bonus code, fish table tips"
              className="w-full rounded-lg border border-border bg-background/60 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-ws-green"
              disabled={loading}
            />
          </div>
