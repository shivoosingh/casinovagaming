  ...
  return [
    {
      ...
      category: "SUNDAY",
      imageUrl: "/images/promos/Casinova_gift_three.jpg",
    ...
    },
    {
      ...
      category: "MONDAY",
      imageUrl: "/images/promos/Casinova_dealer_ten.jpg",
      captionTemplate: (dateStr) =>
    ...
    },
    {
      ...
      category: "TUESDAY",
      imageUrl: "/images/promos/Casinova_model_five.jpg",
      captionTemplate: (dateStr) =>
    ...
    },
    {
      ...
      category: "WEDNESDAY",
      imageUrl: "/images/promos/Casinova_slot_fifteen.jpg",
      captionTemplate: (dateStr) =>
        ...
        <div className="space-y-2">
          ...
          <div className="rounded-2xl border border-sky-500/30 bg-[#17212b] p-4 text-white shadow-xl space-y-3">
            <div className="flex items-center gap-2 border-b border-white/10 pb-2">
              ...
              <div>
                <span className="text-xs font-bold block">Casinova Royale VIP Channel</span>
