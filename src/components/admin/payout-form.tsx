...
export function PayoutForm({
  ...
  return (
    <form ref={formRef} onSubmit={onSubmit} className="flex flex-wrap items-center gap-2">
      ...
      <Input name="note" type="text" placeholder="Note (CashApp / Zelle)" className="h-9 w-40" maxLength={120} />
      <Button type="submit" size="sm" disabled={pending} className="bg-violet-600 hover:bg-violet-500">
