...
export const GEO_STATES: Record<string, StateData> = {
  texas: {
    ...
    heroLede: "Casinova Gaming is available to players across Texas — Houston, Dallas, San Antonio, Austin, Fort Worth, El Paso and more.",
    ...
    cities: [
      ...
      { name: "Austin", slug: "austin", descriptionSnippet: "Austin players can access all 12 Casinova Gaming games" },
  ...
  florida: {
    ...
    heroLede: "Casinova Gaming serves players across Florida — Miami, Orlando, Jacksonville, Tampa, Fort Lauderdale, St Petersburg and beyond.",
  ...
  california: {
    ...
    heroLede: "Casinova Gaming serves players across California — Los Angeles, San Diego, San Francisco, Sacramento, San Jose, Fresno.",
    ...
    cities: [
      ...
      { name: "Fresno", slug: "fresno", descriptionSnippet: "Fresno players access all 12 Casinova Gaming sweepstakes games" },
    ],
  },
  georgia: {
    name: "Georgia", abbr: "GA", slug: "georgia",
    heroLede: "Casinova Gaming is available to players across Georgia including Atlanta, Augusta, Savannah, Columbus, Macon, Athens.",
  ...
  "north-carolina": {
    ...
    heroLede: "Casinova Gaming is available to players across North Carolina including Charlotte, Raleigh, Greensboro, Durham, Fayetteville.",
  ...
  ohio: {
    ...
    heroLede: "Casinova Gaming serves players across Ohio — Columbus, Cleveland, Cincinnati, Toledo, Akron, Dayton.",
    ...
    cities: [
      ...
      { name: "Cincinnati", slug: "cincinnati", descriptionSnippet: "Cincinnati players access all 12 Casinova Gaming games online" },
