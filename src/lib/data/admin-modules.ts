...
export const ADMIN_MODULES = [
  ...
  { href: "/admin/bot-status", label: "Bot Status", icon: "Activity", permission: "cms.manage", group: "AI Automation" },
  { href: "/admin/kyc", label: "KYC Review", icon: "ShieldCheck", permission: "cms.manage", group: "AI Automation" },
  { href: "/admin/marketing", label: "Marketing Hub", icon: "Megaphone", permission: "cms.manage", group: "AI Automation" },
