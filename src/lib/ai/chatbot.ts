...
const PLATFORM_KNOWLEDGE = [
  {
    ...
    answer:
      "🎮 <b>Juwa 777 Game Guide:</b>\nYou can request a Juwa account directly from your Casinova Dashboard under 'Game Requests'. Deposits are processed instantly via USDT, Chime, PayPal, or Cash App!",
    confidence: 0.95,
  },
  {
  ...
  },
  {
    ...
    answer:
      "✨ <b>Orion Stars Guide:</b>\nOrion Stars features premium reel slots and sweepstakes games. Submit a request on Casinova and our automated bot will issue your credentials within minutes!",
    confidence: 0.95,
  },
  {
  ...
  },
  {
    ...
    answer:
      "🙋 <b>Connecting with Support:</b>\nI am escalating your conversation to a live Casinova Customer Support agent right now. A member of our team will reply here shortly!",
    confidence: 0.5,
  },
];
